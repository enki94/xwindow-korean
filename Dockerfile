...
RUN apt-get update
RUN apt-get install -y --no-install-recommends dbus-x11 locales x11-xserver-utils xfce4 xfce4-goodies xorgxrdp xrdp fonts-pretendard fcitx5-hangul sudo vim net-tools chromium git curl npm golang && \
